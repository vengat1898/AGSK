  ...
  const fetchCoupons = async () => {
    try {
      ...
      const response = await axios.get(
        "https://minsway.co.in/leaf/mb/Discount/discount_fetch",
        { params: { mobile } }
      );
      ...
      Alert.alert("Notice", "Couldn't load coupons. You can still proceed with your order.");
    }
  };
...
const handleFinalCheckout = async () => {
  ...
  return (
    <>
      ...
      <View style={styles.invoiceBox}>
        ...
        {discount > 0 && (
          <View style={styles.invoiceRow}>
            <Text style={styles.invoiceLabel}>Coupon ({selectedCoupon?.code})</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Full-width Coupon Banner */}
<TouchableOpacity 
  onPress={() => setIsCouponModalVisible(true)}
  style={styles.couponBannerContainer}
>
  <Image 
    source={coupon} 
    style={styles.couponImageFullWidth} 
    resizeMode="cover"
  />
</TouchableOpacity>
        ...
        {availableCoupons.map(coupon => (
          ...
          >
            ...
            <Text style={styles.couponTerms}>
              ...
              {coupon.freeShipping ? ' | Free Shipping' : ` | ${coupon.discount}% off`}
            </Text>
