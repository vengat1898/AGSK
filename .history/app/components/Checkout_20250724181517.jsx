...
export default function Checkout() {
  ...
  const handleSendEnquiry = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "https://minsway.co.in/leaf/mb/Enquiry/enquiry",
        {
          params: {
            mobile: storedMobile,
            product_id,
  ...
  const handleUpdateAddress = async () => {
    ...
    console.log("Attempting to update address to:", newAddress.trim());
    console.log("For mobile number:", storedMobile);
    ...
    // Simulate API call
    setTimeout(() => {
      console.log("Address update simulation complete");
      setUserDetails(prev => ({ ...prev, address: newAddress.trim() }));
      setShowAddressModal(false);
      setIsUpdatingAddress(false);
      setNewAddress("");
      console.log("Local state updated with new address:", newAddress.trim());
        ...
        <View key={index} style={styles.productItem}>
          ...
          <View style={styles.productInfo}>
            ...
            <Text style={styles.productDetails}>
              {product.count} x ₹{product.unit_price} = ₹{product.total}
            </Text>
        ...
        <View style={styles.paymentOptions}>
          <TouchableOpacity
            style={[
              ...
              selectedPaymentType === "online" && styles.selectedPaymentOption
            ]}
            onPress={() => setSelectedPaymentType("online")}
          >
            <View style={styles.paymentOptionContent}>
              <Ionicons 
                name={selectedPaymentType === "online" ? "radio-button-on" : "radio-button-off"} 
                size={20} 
                color={selectedPaymentType === "online" ? "#4CAF50" : "#ccc"} 
              />
          ...
          <TouchableOpacity
            style={[
              styles.paymentOption,
              selectedPaymentType === "cod" && styles.selectedPaymentOption
            ]}
            onPress={() => setSelectedPaymentType("cod")}
          >
            <View style={styles.paymentOptionContent}>
              <Ionicons 
                name={selectedPaymentType === "cod" ? "radio-button-on" : "radio-button-off"} 
                size={20} 
                color={selectedPaymentType === "cod" ? "#4CAF50" : "#ccc"} 
              />
