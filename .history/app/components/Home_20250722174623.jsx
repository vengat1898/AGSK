...
export default function Home() {
  ...
  const addToCartApiCall = async (productId, detailId, count) => {
    ...
    try {
      ...
      if (response.data.success === 1) {
        ...
        // Show continue button after successful add to cart
  ...
  const handleAddToCartClick = (item) => {
    if (addedToCart[item.product_id]) {
      ...
      const remainingItems = Object.keys(addedToCart).filter(id => id !== item.product_id);
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.rightIcons}>
              ...
              >
                ...
                <View style={styles.badge}>
                  <Text style={styles.badgeText}>{Object.keys(addedToCart).length}</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
      ...
      <ScrollView
        style={styles.body}
        contentContainerStyle={{ paddingBottom: showContinueButton ? 140 : 80 }}
      >
                ...
                <View style={styles.cartButton}>
                  ...
                  >
                    {loadingProducts[item.product_id] ? (
                      <Text
                        style={
                          isInCart ? styles.removeCartText : styles.addCartText
                        }
                      >
        ...
        <View style={styles.continueButtonContainer}>
          ...
          >
            <Text style={styles.continueButtonText}>
              Continue to Cart ({Object.keys(addedToCart).length} item{Object.keys(addedToCart).length > 1 ? 's' : ''})
            </Text>
