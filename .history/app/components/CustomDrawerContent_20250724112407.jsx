  ...
  return (
    ...
    >
      ...
      <View style={styles.overlay}>
        {/* Changed: Overlay now covers remaining space on the right */}
        <Animated.View
          style={[
        ...
        {/* Changed: Overlay touch area now positioned after drawer */}
        <TouchableOpacity
...
const styles = StyleSheet.create({
  overlay: {
    flex: 1,
    flexDirection: "row", // Keep row direction for left alignment
  },
  backgroundOverlay: {
  ...
  drawerContainer: {
    width: width * 0.75, // Changed: Reduced width from 0.8 to 0.75
    backgroundColor: "#fff",
    elevation: 16,
    shadowColor: "#000",
    shadowOffset: {
    ...
    shadowOpacity: 0.25,
    shadowRadius: 8,
    position: "absolute", // Changed: Make it absolute positioned
    left: 0, // Changed: Align to left edge
    top: 0,
    bottom: 0,
  },
  safeArea: {
