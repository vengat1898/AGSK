...
const CustomDrawer = ({ isVisible, onClose }) => {
  ...
  const handleProfileSwitch = async () => {
    ...
    Alert.alert(
      "Switch Profile",
      `Are you sure you want to switch from ${userType} to ${newTypeLabel}?This will affect current carts item to clear`,
      "This will affect current carts item to clear",
      [
        {
          text: "Cancel",
          style: "cancel",
