...
{/* Full-width Coupon Banner with Text Overlay */}
{/* <TouchableOpacity 
    ...
    <View style={styles.couponModalContent}>
      ...
      <View style={styles.modalActions}>
        ...
        <TouchableOpacity
          onPress={() => {
            if (selectedCoupon) {
              // Here you would typically apply the coupon to the order
              Alert.alert(
                "Coupon Applied",
                `${selectedCoupon.code} has been applied to your order`
              );
              // You would add logic here to actually apply the coupon
              // to the cart/order
            }
