...
export default function Checkout() {
        ...
        Alert.alert(
          ...
          [
            ...
            },
            {
              text: "Go to Home",
              style: "cancel",
              onPress: () => router.replace("/components/Order"),
            },
          ]
        );
      } else {
  ...
  const handleUpdateAddress = async () => {
    ...
    try {
      // Here you would make the actual API call to update address
            ...
            {paymentTypes.map((payment) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedPaymentType === payment.id && styles.selectedPaymentOption
                ]}
                onPress={() => {
              ...
              >
                <Ionicons 
                  name={payment.icon} 
                  size={24} 
                  color={selectedPaymentType === payment.id ? "#4CAF50" : "#666"} 
                />
                <Text style={[
                  styles.paymentOptionText,
                  selectedPaymentType === payment.id && styles.selectedPaymentOptionText
                ]}>
                  {payment.label}
                </Text>
              </TouchableOpacity>
