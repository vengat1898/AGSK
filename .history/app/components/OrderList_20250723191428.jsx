...
const OrderList = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "0": return "#FF8C00"; // Orange for pending
      case "1": return "#2E7D32"; // Dark green for accepted/completed
      case "2": return "#D32F2F"; // Red for rejected
  ...
  return (<></>
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>🍃 Fresh Banana Leaf Orders</Text>
        {orders.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Ionicons name="leaf-outline" size={64} color="#66BB6A" />
            <Text style={styles.emptyText}>No orders found</Text>
            <Text style={styles.emptySubText}>Your banana leaf orders will appear here</Text>
          </View>
        ) : (
          <FlatList
            data={orders}
