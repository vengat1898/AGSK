...
export default function Otp() {
  ...
  const handleChange = (text, index) => {
    ...
    // Auto-focus previous input if current field is empty and backspace is pressed
  ...
  const handleResend = async () => {
    ...
    if (resendLoading) return; // Prevent multiple requests
            ...
            >
              <Text style={styles.resendText}>
                ...
                <Text style={[
                  ...
                  (resendLoading || loading) && styles.resendDisabled
                ]}>
