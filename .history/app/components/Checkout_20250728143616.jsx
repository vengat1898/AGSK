  ...
  <View style={styles.couponSection}>
    ...
    >
      <Text style={styles.couponDropdownText}>
        {selectedCoupon ? `${selectedCoupon.code} - ₹${selectedCoupon.discount} off` : "Select a coupon"}
      </Text>
      <Ionicons 
          ...
          availableCoupons.map((coupon) => (
            <TouchableOpacity
              ...
              style={[
                ...
                selectedCoupon?.id === coupon.id && styles.selectedCouponDropdownItem,
              ]}
            ...
            >
              <View style={styles.couponItemContent}>
                ...
                <Text style={styles.couponTerms}>
                  Min. order: ₹{coupon.minOrder} | Valid till: {new Date(coupon.validTo).toLocaleDateString()}
                </Text>
              </View>
