...
export default function PayOnline() {
  ...
  const shareToWhatsApp = async () => {
    ...
    try {
      const message = `Payment Screenshot - Order Total: ₹${params.total_price || 'N/A'}`;
      ...
      Alert.alert('Share Error', 'Failed to share screenshot. Please try again.');
    }
  };
